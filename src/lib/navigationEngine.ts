...
export const INITIAL_ITEMS: NavigationItem[] = [
  ...
  { id: 'rep_rdl_designer', label: 'Report Designer', groupId: 'reports', icon: 'LayoutTemplate', tab: 'rdlReport', subTab: 'report_manager', order: 10, enabled: true, translations: { bn: 'রিপোর্ট ডিজাইনার' } },
  { id: 'rep_custom_report_module', label: 'Custom Report Designer', groupId: 'reports', icon: 'FileText', tab: 'customReportModule', subTab: 'hub', order: 11, enabled: true, translations: { bn: 'কাস্টম রিপোর্ট ডিজাইনার' } },
